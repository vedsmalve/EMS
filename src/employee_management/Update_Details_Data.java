   ...
   public void actionPerformed(ActionEvent e)
   {
       ...
       if (e.getSource()==bt1)
       {
           try
           {
               ...
               String p = "Update employee set name = '"+name+"',fname='"+fname+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',education='"+education+"',job_post='"+job_post+"',aadhar='"+aadhar+"' where Eid ='"+id+"'";
